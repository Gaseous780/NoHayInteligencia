...
{
    public static List<Node> Run(Node initialNode, Func<Node, bool> isSatified, Func<Node, List<Node>> getConections, Func<Node, Node, float> getCosts, Func<Node, float> heuristic, Func<Node, Node, bool> hasLineOfSight, int watchDog = 1000)
    {
